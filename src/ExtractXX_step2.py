...
parser = ArgumentParser(description="Run 10x Extract -- step2")
...
if __name__ == "__main__":
    if len(sys.argv) == 1:
        os.system("python ExtractXX_step2.py -h")
    else:
        ...
        command_1 = "./ExtractXX_step2.sh "  + args.out_dir + " " + args.barcode_whitelist + " " + args.h5_dir + " " + args.Cr + " " + args.fastq_RA + " " + args.fastq_I1 + " " + args.flag
        os.system(command_1)
